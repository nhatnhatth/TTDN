...
public class ZipFragment extends BaseFragment<FragmentMediaBinding> {
    ...
    protected void initView() {
        adapter = new DocAdapter(LoadFilesTask.zipFiles, requireActivity());
    ...
    private void deleteF(ItemmFile item) {
        ...
        dialog.setCallback(new OnActionCallback() {
            ...
            public void callback(String key, Object... data) {
                ...
                adapter.notifyItemRemoved(LoadFilesTask.zipFiles.indexOf(item));
                LoadFilesTask.zipFiles.remove(item);
