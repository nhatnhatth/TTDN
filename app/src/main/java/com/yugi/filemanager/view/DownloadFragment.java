...
public class DownloadFragment extends BaseFragment<FragmentMediaBinding> {
    ...
    protected void initView() {
        adapter = new DocAdapter(LoadFilesTask.downloadFiles, requireActivity());
    ...
    private void deleteF(ItemmFile item) {
        ...
        dialog.setCallback(new OnActionCallback() {
            ...
            public void callback(String key, Object... data) {
                ...
                adapter.notifyItemRemoved(LoadFilesTask.downloadFiles.indexOf(item));
                LoadFilesTask.downloadFiles.remove(item);
