...
public class VideoFragment extends BaseFragment<FragmentMediaBinding> {
    ...
    protected void initView() {
        adapter = new MediaAdapter(LoadFilesTask.videoFiles, requireActivity());
        adapter.setCallback(new OnActionCallback() {
            ...
            public void callback(String key, Object... data) {
                ...
                intent.setDataAndType(uri, "video/*");  // MIME type for image files
    ...
    private void deleteF(ItemmFile item) {
        ...
        dialog.setCallback(new OnActionCallback() {
            ...
            public void callback(String key, Object... data) {
                ...
                adapter.notifyItemRemoved(LoadFilesTask.videoFiles.indexOf(item));
                LoadFilesTask.videoFiles.remove(item);
