...
public class AudioFragment extends BaseFragment<FragmentMediaBinding> {
    ...
    protected void initView() {
        adapter = new DocAdapter(LoadFilesTask.audioFiles, requireActivity());
    ...
    private void deleteF(ItemmFile item) {
        ...
        dialog.setCallback(new OnActionCallback() {
            ...
            public void callback(String key, Object... data) {
                ...
                adapter.notifyItemRemoved(LoadFilesTask.audioFiles.indexOf(item));
                LoadFilesTask.audioFiles.remove(item);
