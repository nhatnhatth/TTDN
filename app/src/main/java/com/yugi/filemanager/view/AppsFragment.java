...
public class AppsFragment extends BaseFragment<FragmentMediaBinding> {
    ...
    protected void initView() {
        adapter = new DocAdapter(LoadFilesTask.appFiles, requireActivity());
    ...
    private void deleteF(ItemmFile item) {
        ...
        dialog.setCallback(new OnActionCallback() {
            ...
            public void callback(String key, Object... data) {
                ...
                adapter.notifyItemRemoved(LoadFilesTask.appFiles.indexOf(item));
                LoadFilesTask.appFiles.remove(item);
